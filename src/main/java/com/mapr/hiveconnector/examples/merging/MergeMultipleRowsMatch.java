...
/**
 * The class MergeMultipleRowsMatch describes merging operation
 * when multiple source rows match a given target row (cardinality violation),
 * using Hive MapR DB JSON connector.
 */
public class MergeMultipleRowsMatch {
    /**
     * The source table name.
     */
    private String tableSrc = "customer_new_java";

    /**
     * The target table name.
     */
    private String tableTar = "customer_db_json_java";
     ...
     */
    private String insertSrcSQL1 = "INSERT INTO TABLE " + tableSrc + " VALUES ('001', 'Dorothi', 'Hogward', 77)";
    private String insertSrcSQL2 = "INSERT INTO TABLE " + tableSrc + " VALUES ('001', 'Dorothi', 'Hogward', 77)";
    ...
    public static void main(String[] args) {
        ...
        try (Connection connection = DaoManager.getInstance().getConnection();
            ...
            MergeMultipleRowsMatch merge = new MergeMultipleRowsMatch();
