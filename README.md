...
This repository contains examples to discover the key features of the Hive connector for MapR Database JSON table. 
...
```sh
hive> hive> select * from customer_db_json;
